# predictor-ml-rf Specification

## Purpose
Cached Random Forest appearance-score experiment for Predictor: train on refresh (main-six, all history), serve status/predict APIs, and expose honest holdout R² and hit-count metrics without claiming win probability.
