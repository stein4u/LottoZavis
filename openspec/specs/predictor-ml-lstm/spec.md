# predictor-ml-lstm Specification

## Purpose
Manual-train cached sequence-window LSTM experiment for Predictor: main-six multi-hot windows, status/predict APIs, and honest hit-count / val-loss / prize-simulation metrics without claiming win probability.
