...
앱과 위키의 **최신 회차·당첨번호**는 항상 동일해야 한다. 불일치 시 앱 캐시를 기준으로 wiki analyses를 갱신한다 (Phase 0.5).
...
2026-07-05 이전 ingest로 생성된 아래 페이지는 **메인 6볼만** 집계했다. canonical은 Tier A이며, Tier A 재산출은 Phase 0.5에서 수행한다.

- [[analyses/frequency-snapshot-2026-07-05]]
- [[analyses/freq-trend-2026-07-05]]
- [[sources/dhlottery-official-draws]] (스냅샷 표 일부)
...
앱 내 `preseededArticles`(ML 파이프라인 서술)는 **deprecated**. Phase 1 Reader 통합 시 본 위키(`wiki/`) 톤으로 대체한다.
